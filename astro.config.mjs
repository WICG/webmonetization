...
export default defineConfig({
  ...
  redirects: {
    ...
    "/docs/references/attributes/amountsent": "/developers/events",
    "/docs/references/attributes/incomingpayment": "/developers/events",
    "/docs/references/attributes/paymentpointer": "/developers/events",

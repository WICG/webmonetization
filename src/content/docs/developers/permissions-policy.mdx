...
A <LinkOut href="https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Permissions-Policy">Permissions Policy</LinkOut> provides a mechanism for you to explicitly declare what functionality can and can't be used on your website.

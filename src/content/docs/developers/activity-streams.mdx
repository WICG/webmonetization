...
Social web community servers and apps can expose the wallet address or payment pointer of a user or post to a Web Monetization client, such as the ILF's [Web Monetization browser extension](/supporters/get-started#1-download-and-install-the-extension) or embedded SDK.

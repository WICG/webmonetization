...
The [Publisher Tools](https://webmonetization.org/tools) page provides a collection of easy-to-customize components that you can use to tell your visitors about Web Monetization.
...
<LinkButton href="https://webmonetization.org/create/banner" icon="external" iconPlacement="start" variant="secondary">Create a banner</LinkButton>
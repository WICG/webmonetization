...
| [walletAddress](/developers/events#walletaddress)                                                              | The URL of the wallet address that the incoming payment request was sent to.                                                                                                                |
| [paymentPointer](/developers/events#paymentpointer) <Badge text="Deprecated" variant="caution" size="small" /> | Deprecated alias for `walletAddress`. Retained for backward compatibility only.                                                                                                             |

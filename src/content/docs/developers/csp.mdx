...
<table>
  ...
  <tr>
    ...
    <td>
      {/* prettier-ignore */}
      <LinkOut href='https://developer.mozilla.org/en-US/docs/Glossary/Fetch_directive'>Fetch directive</LinkOut>
    </td>
  </tr>
</table>
...
Where `<value>` is a wallet address that's allowed to load.

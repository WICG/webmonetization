...
### Step 1 - Check for Web Monetization
...
### Step 2 - Issue request to payment pointer

<p style="font-size: 14px">Open Payments API: <LinkOut href="https://docs.openpayments.guide/reference/get-payment-pointer">GET Payment Pointer</LinkOut></p>
...
### Step 3 - Send an incoming payment grant request

<p style="font-size: 14px">Open Payments API: <LinkOut href="https://docs.openpayments.guide/reference/post-request">POST Grant Request</LinkOut></p>
...
### Step 4 - Create an incoming payment request

<p style="font-size: 14px">Open Payments API: <LinkOut href="https://docs.openpayments.guide/reference/create-incoming-payment">POST Incoming Payment</LinkOut></p>
...
:::note
*Incoming* payment is used here because the WM agent is requesting that the WM receiver allow an incoming payment to Alice's account. The payment itself has not been sent yet.
:::
...
### Step 5 - Send a quote request

<p style="font-size: 14px">Open Payments API: <LinkOut href="https://docs.openpayments.guide/reference/create-quote">POST Quote</LinkOut></p>
...
### Step 6 - Send outgoing payment request

<p style="font-size: 14px">Open Payments API: <LinkOut href="https://docs.openpayments.guide/reference/create-outgoing-payment">POST Outgoing Payment</LinkOut></p>

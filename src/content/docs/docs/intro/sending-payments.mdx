...
Depending on which form a WM provider takes, the provider's user may not know, nor have a need to know, any details about a sending account's payment pointer.

...
<div class="draft">
  <h5>Page Updates</h5>
  <ul>
    <li>Update Glitch example's README</li>
    <li>Change all references to $example.com/ to $wallet.example/ on page and in Glitch</li>
    <li>Tie page into the revshare generator; make sure this page and the generator are accurate</li>
  </ul>
</div>

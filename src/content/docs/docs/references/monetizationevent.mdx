...
<div class="draft"><h5>Page Updates</h5><ul><li>Add any appropriate links</li><li>Add browser compat if appropriate</li></ul></div>
...
- [amountSent](/docs/references/attributes/amountsent) - A dictionary containing the amount and currency code of the sent payment
- [incomingPayment](/docs/references/attributes/incomingpayment) - returns incoming payment URL
...
<Specifications link="monetizationevent-interface"></Specifications>
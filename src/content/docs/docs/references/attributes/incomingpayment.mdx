...
<div class="draft"><h5>Page Updates</h5><ul><li>Add any appropriate links</li><li>Add browser compat if appropriate</li><li>Verify example</li></ul></div>
...
<Specifications link="incomingpayment-attribute"></Specifications>
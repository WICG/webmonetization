...
<div class="draft"><h5>Page Updates</h5><ul><li>Add any appropriate links</li><li>Add browser compat if appropriate</li><li>Verify example</li><li>Clarify "note", it's kind of confusing</li></ul></div>
...
<Specifications link="permissions-policy"></Specifications>
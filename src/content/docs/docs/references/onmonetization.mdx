...
<div class="draft"><h5>Page Updates</h5><ul><li>Add any appropriate links</li><li>Add browser compat if appropriate</li><li>Check tooltip definition</li><li>Verify example</li></ul></div>
...
<Specifications link="onmonetization-event-handler"></Specifications>
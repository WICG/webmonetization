...
Compare this format with what's used on the [Web Monetization flow page](/docs/intro/web-monetization-flow#example-flow). Which is better?

Questions about this format:
* Will people notice there are tabs?
* Are tabs accessible? Will users with screen readers know they're there? Can they easily navigate to them?
* What happens if a search result hits on content within a Response tab? If you select the search result, where on the page will you land? 

## Example flow

### Steps
1. [Check for Web Monetization](#1)
2. [Issue request to payment pointer](#2)
3. [Send an incoming payment grant request](#3)
4. [Create an incoming payment request](#4)
5. [Send a quote request](#5)
6. [Send outgoing payment request](#6)
...
<a id="1"></a><StylishHeader>Step 1 - Check for Web Monetization</StylishHeader>
...
<a id="2"></a><StylishHeader>Step 2 - Issue request to payment pointer</StylishHeader>
...
<a id="3"></a><StylishHeader>Step 3 - Send an incoming payment grant request</StylishHeader>
...
<a id="4"></a><StylishHeader>Step 4 - Create an incoming payment request</StylishHeader>
...
<a id="5"></a><StylishHeader>Step 5 - Send a quote request</StylishHeader>
...
<a id="6"></a><StylishHeader>Step 6 - Send outgoing payment request</StylishHeader>

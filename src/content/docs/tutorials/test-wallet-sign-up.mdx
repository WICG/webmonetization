...
As you go through the Know Your Customer (KYC) check, the only real information you must share is your email address and phone number for verification purposes. 
      
All other information, including identity documentation, can be fake. If you're asked to upload a photo, it can be of anything as long as it's not blank. A face scan might also be required but is not used by the test wallet in any way.

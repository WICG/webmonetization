...
Sign up with the Interledger Foundation's <LinkOut href="https://wallet.interledger-test.dev">test wallet</LinkOut> to experiment with sending and receiving Web Monetization payments without using real money.
...
:::note[Pre-production environment]

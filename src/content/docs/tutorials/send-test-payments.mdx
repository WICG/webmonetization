...
<Steps>
    ...
    2. Download and install the Interledger Foundation's <LinkOut href="https://webmonetization.org/install">Web Monetization browser extension</LinkOut>.
...
The currency of this page's test wallet is denominated in Mexican pesos (MXN). Regardless of the currency used by your test wallet, the recipient receives payments in MXN.
...
If your extension is using USD with the default rate of $0.60 an hour, a new event appears on the site about every two minutes.

After one or more payments are made, sign in to your <LinkOut href="https://wallet.interledger-test.dev/">wallet account</LinkOut> and select **Transactions** to see your outgoing payments.
...
<Steps>
    ...
    2. Ensure your extension's icon shows a green circle: ![Active extension with green circle](/img/docs/extension/enabled-monetized.png)
    ...
    5. Sign in to your <LinkOut href="https://wallet.interledger-test.dev/">wallet account</LinkOut> and select **Transactions** to see your outgoing payment.
</Steps>
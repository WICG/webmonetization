...
<Steps>
  ...
  5. Click **Create**. Your payment pointer should show in the _Payment Pointers_ section.<br /><img src='/img/docs/testwallet/testwallet-nobalance-pp.png' alt='Account showing no balance and newly created payment pointer' style='max-width:350px' class='img-outline'/>
</Steps>
...
<Steps>
  ...
  2. Enter an amount, then click **Deposit**.<br /><img src='/img/docs/testwallet/testwallet-deposit.png' alt='Deposit to account screen with amount field' style='max-width:350px' class='img-outline'/>
</Steps>

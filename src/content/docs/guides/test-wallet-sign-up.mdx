...
<Steps>
  <ol>
    ...
    <li>
      Enter any account name, select any asset (currency), then click **Create
      account**.
      <img
    ...
    <li>Click **Close**, then select your new account from the dashboard.</li>
    <li>
      Select **Add payment pointer**, then enter a payment pointer name and
      public name of your choosing.
      <img
    ...
    <li>
      Click **Create**. Your payment pointer should show in the _Payment
      Pointers_ section.
      <img

...
<Steps>
  ...
  4. Log in to your newly created account and complete the Know Your Customer (KYC) and liveness checks.
</Steps>

## Step 2 - Complete KYC and liveness checks
     
As you go through the Know Your Customer (KYC) check, the only real information you must share is your email address and phone number for verification purposes. All other information, including identity documentation, can be fake because you're signing up for a test environment. If you're asked to upload a photo, it can be of anything as long as it's not blank. A face scan might also be required but is not used by the test wallet in any way.

:::note[Reason for checks]
The Interledger test wallet runs on a GateHub pre-production environment. This environment mimics their production environment, including **all** the <LinkOut href="https://support.gatehub.net/hc/en-us/articles/360021131234-KYC-requirements-for-account-verification">KYC steps</LinkOut>.
:::

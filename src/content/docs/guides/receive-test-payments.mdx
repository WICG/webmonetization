...
<Card title="Outgoing payment amounts">
  To mimic how a real wallet provider could act, the Interledger test network deducts a 0.01 fee from each outgoing payment. If your rate is €0.60{' '}
  <abbr title="euros">EUR</abbr> an hour, each Playground event will show €0.01 EUR while each outgoing payment in your transaction list will show a debit of €0.02.
</Card>

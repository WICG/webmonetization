...
<details>
  ...
  <Steps>
    <ol>
      <li>
        Select your wallet, then click **Advanced**.
        <img
      ...
      <li>Scroll down to **Interledger Settings**.</li>
      <li>
        Click the **Payment pointer** button.
        <img
...
<details>
  ...
  <Steps>
    <ol>
      <li>Open the Chimoney App and navigate to the **Account** tab.</li>
      <li>
        Click on **Interledger Wallet Address**.
        <img
      ...
      <li>
        Copy your wallet address. It will look like
        `https://ilp.chimoney.com/username` or
        `https://ilp.chimoney.com/123456`.
      </li>
    </ol>
  </Steps>

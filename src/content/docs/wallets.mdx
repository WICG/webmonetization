...
| --------------------------------------------------------------------- | --------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| <LinkOut href="https://interledger.app/">Interledger Wallet</LinkOut> | USA, EU, South Africa | $ <abbr title="US dollars">USD</abbr>, € <abbr title="euros">EUR</abbr>, R <abbr title="South African rand">ZAR</abbr> |
...
1. Select your wallet, then click **Advanced**.
   <img
     ...
     alt="Advanced option highlighted on the user's wallet screen"
     class="img-outline"
     style="max-width: min(100%, 600px)"
   />
...
3. Click the **Payment pointer** button.
   <img
     ...
     alt="Interledger Settings section showing the Interledger payment pointer button. The user's payment pointer itself is hidden."
     class="img-outline"
...
4. Copy your payment pointer.
   <img
     ...
     alt="Interledger settings section showing the user's payment pointer"
     class="img-outline"
     style="max-width: min(100%, 600px)"
   />

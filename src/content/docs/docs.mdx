...
<div style="position: relative; top: -100px; background-color: white; height: 75px; padding: 10px 0 0 0;"><img src="/img/wm-logo--full-animated.svg" alt="Web Monetization logo" style="width: 100%; max-width: 600px; height: auto;"/></div>
...
<div style="margin-top:-60px;">
  <CardGrid>
    ...
    <LinkCard title="Get the browser extension" href="https://webmonetization.org/install/" target="_blank" description="Download the Interledger Foundation's browser extension. Currently available for Chrome, Firefox, and Edge." />
  </CardGrid>
</div>
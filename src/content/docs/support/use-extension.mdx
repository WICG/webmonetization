...
If you're interested in web monetizing your own content, the [quick start guide](/experiment/quick-start) is a good place to start.

<StylishHeader>Web Monetization payments</StylishHeader>

To make Web Monetization payments, you only need a digital wallet from a Web Monetization-compatible [wallet provider](/resources/wallets). There's no site-by-site account or subscription required for each individual site you want to support.
...
:::note[Permissions]
The extension will ask for permission to access your browser tabs and your data for all websites. The extension requires these permissions to check each page you visit for the Web Monetization [`<link>`](/experiment/link-element) element.
:::

### 2. Sign up with a compatible digital wallet

Sign up with a Web Monetization-compatible [wallet provider](/resources/wallets).
...
Visit the [Web Monetization-enabled wallets](/resources/wallets) page for a list of compatible wallet providers.
</details>

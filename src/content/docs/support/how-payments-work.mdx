...
To send (and receive) Web Monetization payments, you must have an account with a compatible digital wallet. Not all digital wallets support Web Monetization payments. 

A digital wallet is the entity that supplies you with the account you'll use to make  payments. Funding your account typically requires you to link a card or bank to your wallet. 
...
You must have an account with a [compatible digital wallet](/resources/wallets) to send Web Monetization payments. Be sure to select a wallet that's available in your region and supports your preferred currency. 
...
The [Web Monetization extension](/support/use-extension) for Google Chrome is what you'll use to enable and configure Web Monetization payments. 

:::tip[Browser support]
The extension is only available on Google Chrome. More browsers will be supported in the future.
:::

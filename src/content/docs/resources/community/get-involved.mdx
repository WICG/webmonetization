...
* Update the existing Web Monetization v1 [tools/libraries](/resources/community/libraries/) to the latest spec.
...
* <LinkOut href="https://github.com/WICG/webmonetization?tab=readme-ov-file#localizationinternationalization">Translate and localize</LinkOut> the [Intro to Web Monetization page](/docs/) into one of the following languages:
    * Arabic
    * Chinese
    * French
    * German

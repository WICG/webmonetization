...
Review the [Test Web Monetization](/tutorials/test-web-monetization) tutorial to learn more about sending and receiving payments through the test wallet. Go to <LinkOut href="https://wallet.interledger-test.dev">wallet.interledger-test.dev</LinkOut> to sign up for an account.

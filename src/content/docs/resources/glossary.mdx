...
<LinkOut href="https://openpayments.dev">Open Payments</LinkOut> is an open standard for implementation by wallet providers. When implemented, third-party applications, like the Web Monetization extension, can set up payments to and from users' wallet accounts.

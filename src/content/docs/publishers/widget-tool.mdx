...
3. Click **Confirm**. You're directed to your wallet provider to sign in and confirm your ownership of the wallet address. After confirmation, you'll return to the Widget tool page.
4. Copy the script that appears in the overlaid screen.
   ...
   ></script>
   ```
5. Add the script to your site. We recommend placing it just before the closing `</body>` tag. If you're using a site management tool like WordPress, you'll place the code in a script-type element.
6. Go to your site and check that the widget appears correctly.

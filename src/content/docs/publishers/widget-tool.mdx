...
- Only the address connected to the widget will receive one-time payments, even if your site is monetized with multiple wallet addresses.
...
2. Expand the _Content_ section. Enter a title for the widget or choose from the suggested options.<br /><img src="/img/docs/pubtools/widget-title.png" alt="Panel showing suggested titles and a field to enter a custom title" style="max-width: 60%" class='img-outline' />

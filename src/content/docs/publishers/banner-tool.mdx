...
2. Expand the _Content_ section. Enter a title for the banner or choose from the suggested options.<br /><img src="/img/docs/pubtools/banner-title.png" alt="Panel showing suggested titles and a field to enter a custom title" style="max-width: 60%" class='img-outline' />

...
<Badge text="Web Monetization API" variant="tip" style="position: relative; top:-30px;" />
...
3. The site visitor's Web Monetization agent calls the Open Payments APIs to begin setting up the payment. More information about these API calls is provided in the [How payments work](/experiment/how-payments-work#a-deeper-dive-into-payments) page.

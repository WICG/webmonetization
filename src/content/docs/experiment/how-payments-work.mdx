...
Your wallet provider will assign your account a unique identifier called either a *payment pointer* or a *wallet address*. This identifier is kind of like an account name. It is publicly shareable and you will need it when web monetizing your content. 

---
title: Link element monetization agent
---
...
- Processing the monetization link or links in an HTML page
- Instrumenting payments by calling the [Open Payments APIs](/publishers/about-receiving#a-deeper-dive-into-payments), which are APIs implemented by wallet providers

---
title: Link element iframes
---

Nested browsing contexts (iframes) can contain monetization `<link>` elements, but your site visitor’s Web Monetization agent determines how iframes are monetized. A few examples of how a Web Monetization agent can monetize iframes include:

- Splitting payments evenly between all monetization links in both the parent and the iframe

...
L'image suivante montre le flux de la Monetization Web à un niveau élevé. Certaines étapes ont été combinées ou exclues. Une explication plus détaillée est fournie dans la page [Flux de la Web Monetisation](/fr/docs/intro/web-monetization-flow).
...
5. Le flux de monétisation Web se termine. Le traitement des paiements, l'échange de devises et le règlement ont lieu entre les deux comptes par l'intermédiaire d'un rail de paiement commun.

...
Web Monetization doesn't provide the recipient with personally identifiable information such as your name, wallet address/payment pointer, IP address, or anything else the recipient could use to correlate a payment with you.
...
### Web Monetization isn't tied to a specific currency.
...
### Web Monetization isn't an ad blocker.

...
<Steps>
  <ol>
    <li>
      Ensure the address shown above the amount field is the page you intend to pay.
      <img
...
<Steps>
  <ol>
    ...
    <li>Select the **Monthly** toggle to enable/disable monthly renewals of your budget.</li>
    <li>Click **Submit changes**. A new tab opens to your wallet provider.</li>
    <li>Sign in to your wallet account if needed, then confirm the new budget.</li>
  </ol>
</Steps>
...
<Steps>
  <ol>
    ...
    <li>Enter a nickname for the key, then paste the key into the public key field.</li>
    <li>Click **Save**.</li>

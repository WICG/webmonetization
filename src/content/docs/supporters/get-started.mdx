...
<Steps>
  ...
  <img
    ...
    class='img-outline'
  />
  :::note You may experience a delay before you can fund your wallet while your
  provider performs necessary regulatory checks. ::: 2. Find and copy your
  wallet address (Interledger) or payment pointer (GateHub). You'll need it for
  Step 4.
  <br />
  <img
  ...
  <img
    ...
    class='img-outline'
  />
  5. Enter the amount the extension will have permission to send and select
  whether the amount should renew monthly. You can always [change these
  settings](#adjust-your-budget) later. :::note The amount and renewal frequency
  is specific to the extension you're setting up. If you install the extension
  on a different browser and connect to the same wallet, that extension will
  have a separate budget. Payments made from one budget don't affect the balance
  of the other. ::: 6. Click **Connect**, then click **Agree** to allow the
  extension to connect to your wallet account.
  <br />
  <img
    ...
    class='img-outline'
  />
  :::note If your wallet provider's website opens in your browser, proceed to
  the next step. If you receive a connection error, review the instructions for
  [resolving the error](#resolve-a-key-addition-failure). ::: 7. Sign in to your
  wallet account if you haven't already, then confirm the connection and budget
  amount. For example:
  <br />
  <img
    ...
    class='img-outline'
  />
  8. A success screen appears when the connection is successful. You can close
  the tab.
  <br />
  <img
...
<Steps>
  ...
  Alternatively, select the **Continuous payment** toggle to enable/disable
  continuous payments for all web monetized pages.
</Steps>
...
<Steps>
  1. Ensure the address shown above the amount field is the page you intend to
  pay.
  <br />
  <img
    ...
    class='img-outline'
  />
  2. Enter an amount. Be sure your balance can cover the amount, otherwise the
  payment will fail. Click **Send now**.
  <br />
  <img
...
<Steps>
  ...
  <img
    ...
    class='img-outline'
  />
  3. Enter the new amount in the **Budget amount** field. 4. Select the
  **Monthly** toggle to enable/disable monthly renewals of your budget. 5. Click
  **Submit changes**. A new tab opens to your wallet provider. 6. Sign in to
  your wallet account if needed, then confirm the new budget.
</Steps>
...
<Steps>
  1. Sign in to your Interledger Wallet. 2. Select **Settings** from the left
  menu. 3. Select **Keys**. 4. Click **Add a public key**. 5. Enter a nickname
  for the key, then paste the key into the public key field. 6. Click **Save**.

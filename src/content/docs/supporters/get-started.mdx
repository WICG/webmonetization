...
<Steps>
  <ol>
    <li>
      Get a Web Monetization-compatible [wallet](/wallets).
      <img
      ...
      :::note
      You may experience a delay before you can fund your wallet while your
      provider performs necessary regulatory checks.
      :::

    </li>
    <li>
      Find and copy your wallet address (Interledger) or payment pointer
      (GateHub). You'll need it for Step 4.
      <img
    ...
    <li>
      Enter the amount the extension will have permission to send and select
      whether the amount should renew monthly. You can always [change these
      settings](#adjust-your-budget) later.

      :::note
      The amount and renewal frequency is specific to the extension you're
      setting up. If you install the extension on a different browser and
      connect to the same wallet, that extension will have a separate budget.
      Payments made from one budget don't affect the balance of the other.
      :::

    </li>
    <li>
      Click **Connect**, then click **Agree** to allow the extension to connect
      ...
      :::note
      If your wallet provider's website opens in your browser, proceed to the
      next step. If you receive a connection error, review the instructions for
      [resolving the error](#resolve-a-key-addition-failure).
      :::

    </li>
    <li>
      Sign in to your wallet account if you haven't already, then confirm the
    ...
    <li>
      A success screen appears when the connection is successful. You can close
      the tab.
      <img
...
<Steps>
  <ol>
    ...
    <li>
      Enter the amount the extension will send, per hour, to web monetized
      sites. Alternatively, select the **Continuous payment** toggle to
      enable/disable continuous payments for all web monetized pages.
    </li>
  </ol>
</Steps>
...
<Steps>
  <ol>
    <li>
      Ensure the address shown above the amount field is the page you intend to
      pay.
      <img
    ...
    <li>
      Enter an amount. Be sure your balance can cover the amount, otherwise the
...
<Steps>
  <ol>
    ...
    <li>Enter the new amount in the **Budget amount** field.</li>
    <li>
      Select the **Monthly** toggle to enable/disable monthly renewals of your
      budget.
    </li>
    <li>Click **Submit changes**. A new tab opens to your wallet provider.</li>
    <li>
      Sign in to your wallet account if needed, then confirm the new budget.
    </li>
  </ol>
</Steps>
  ...
  <ol>
    ...
    <li>
      ...
      <img
        ...
        class="img-outline"
      />
      The extension's setup screen appears with your previously used wallet
      address and budget settings prefilled.
      <img
...
<Steps>
  <ol>
    <li>Sign in to your Interledger Wallet.</li>
    <li>Select **Settings** from the left menu.</li>
    <li>Select **Keys**.</li>
    <li>Click **Add a public key**.</li>
    <li>
      Enter a nickname for the key, then paste the key into the public key
      field.
    </li>
    <li>Click **Save**.</li>
    <li>Go back to your extension and try connecting again.</li>
  </ol>
</Steps>

...
By default, the extension is set to send continuous payments at a rate of $0.60 <abbr>USD</abbr> an hour ($0.01 a minute). If you transact in a currency other than <abbr>USD</abbr>, then the extension will default to your currency's equivalent based on the exchange rate. For example, if you transact in Mexican pesos, $0.60 <abbr>USD</abbr> is equivalent to around <abbr>MX</abbr> $11.70. The extension will default to <abbr>MX</abbr> $11.70 an hour.

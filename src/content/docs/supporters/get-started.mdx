...
<a href="https://chromewebstore.google.com/detail/web-monetization/oiabcfomehhigdepbbclppomkhlknpii" target="_blank"><button class="chrome"></button></a>

<a href="https://addons.mozilla.org/en-US/firefox/addon/web-monetization-extension/" target="_blank"><button class="firefox"></button></a>

<a href="https://microsoftedge.microsoft.com/addons/detail/web-monetization/imjgemgmeoioefpmfefmffbboogighjl" target="_blank"><button class="edge"></button></a>

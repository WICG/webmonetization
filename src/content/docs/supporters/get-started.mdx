...
<LinkButton 
  href="https://chromewebstore.google.com/detail/web-monetization-extensio/oiabcfomehhigdepbbclppomkhlknpii"
  variant="primary"
  icon="external"
  iconPlacement="start"
>
...
<LinkButton 
  href="https://microsoftedge.microsoft.com/addons/detail/web-monetization-extensio/imjgemgmeoioefpmfefmffbboogighjl"
  variant="primary"
  icon="external"
  iconPlacement="start"
>
...
<Steps>
  ...
  3. Optionally select the **Renew monthly** toggle. If you choose to not renew monthly, you'll need to manually [add more funds](#adjust-your-budget) when your remaining balance is zero.
      :::caution  
      Your budget amount and renewal frequency is tied to this extension on your current browser. If you install the extension on a different browser and connect to the same wallet account, that extension will have a separate budget. Sending payments from one budget will not affect the balance of the other budget.
      :::
  4. Click **Connect**.
...
Payments continue for as long as the page is active and in view. Continuous payments stop if you:
* Disable continuous payments within the extension
* Minimize your browser
* Close the page/tab/browser

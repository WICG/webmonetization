...
head:
  - tag: style
    content: .chrome {background-color:#327374;background-image:url('/img/chrome-webstore.png');background-size:50px;background-repeat:no-repeat;background-position:50%;border:none;cursor:pointer;border-radius:10px;text-decoration:none;color:white !important;width:70px;height:70px;margin:15px 15px 15px 0} .firefox {background-color:#327374;background-image:url('/img/Fx-Browser-icon.png');background-size:50px;background-repeat:no-repeat;background-position:50%;border:none;cursor:pointer;border-radius:10px;text-decoration:none;color:white !important;width:70px;height:70px;margin:15px 15px 15px 0} .edge {background-color:#327374;background-image:url('/img/microsoft-edge.png');background-size:50px;background-repeat:no-repeat;background-position:50%;border:none;cursor:pointer;border-radius:10px;text-decoration:none;color:white !important;width:70px;height:70px;margin:15px 15px 15px 0}
---
...
<a href="https://chromewebstore.google.com/detail/web-monetization/oiabcfomehhigdepbbclppomkhlknpii"><button class="chrome"></button></a>

<a href="https://addons.mozilla.org/en-US/firefox/addon/web-monetization-extension/"><button class="firefox"></button></a>

<a href="https://microsoftedge.microsoft.com/addons/detail/web-monetization/imjgemgmeoioefpmfefmffbboogighjl"><button class="edge"></button></a>

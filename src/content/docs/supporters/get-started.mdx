...
<Steps>
  <ol>
    ...
    <li>
      Enter the amount the extension will have permission to send and select whether the amount should renew monthly. You can always [change these settings](#adjust-your-budget) later.
    ...
    <li>
      Click **Connect**, then click **Agree** to allow the extension to connect to your wallet account.
      <img

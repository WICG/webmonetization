...
export default function BrowserCompat({ children, data }) {
  ...
  return (
    <div className='browser-compat'>
          ...
          {Object.keys(compat).map((key) => {
            return (
              <tr>
                ...
                {Object.keys(compat[key].__compat.support).map((platform) => {
                  if (platform !== 'status')
                    return (
                      <td
                      ...
                      >
                        ...
                        <span class='bc-icons'>
                          {compat[key].__compat.support[platform].notes && (
                            <Extension fontSize='inherit' htmlColor='green' />
                          )}
                        </span>
                      </td>
                    )
      ...
      <span class="bc-notes"><Check fontSize='inherit' htmlColor='green' /> Full Support.</span>
      <span class="bc-notes"><Cancel fontSize='inherit' htmlColor='red' /> No Support.</span>
      <span class="bc-notes"><Extension fontSize='inherit' htmlColor='green' /> You'll need to use a <a href="/docs/extension">Web Monetization Extension</a>.</span>
    </div>
  )
}

...
| requestId | String | The session ID/Monetization ID (UUID v4) [generated by the browser](/docs/explainer#flow) for the Web Monetization `meta` tag at the time when payment has stopped. |
